...
.. tip::
   ...
   cfoldseeker’s remote mode requires a local copy of UniProt’s ID mapping table. We have prepared a ready-to-use reduced version from the 2026_01 release only containing the KEGG and GenPept rows. For your convenience, we attach it to `every GitHib release <https://cfoldseeker.readthedocs.io/en/latest/guide/install.html>`_ as `uniprot_kegg_genpept.gz`.
